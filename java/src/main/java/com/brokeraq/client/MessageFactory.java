...
public class MessageFactory {
	...
	public BaseMessage buildPing(){
		AQMessages.InfoEvent i = AQMessages.InfoEvent.newBuilder().setMessage("").setTimestamp(0L).build();		
		return wrap(BaseMessage.CommandType.INFO_EVENT, AQMessages.InfoEvent.cmd, i);
	}
